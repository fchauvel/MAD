...
class SuccessfulTests(MadAcceptanceTests):
    ...
    def test_priority_scheme(self):
        ...
        self._verify_valid_model()
        self._verify_no_warnings()
        self._verify_successful_task_count("Browser_A", 3)
        self._verify_successful_task_count("Browser_B", 0)
        self._verify_reports_for(["DB"])
        self._verify_log()
        self._verify_model_copy()
    ...
    def test_fail(self):
        ...
        self._verify_valid_model()
        self._verify_no_warnings()
        self._verify_successful_task_count("Browser", 0)
        self._verify_reports_for(["DB"])
        self._verify_log()
        self._verify_model_copy()
    ...
    def test_retry(self):
        ...
        self._verify_no_warnings()
        self._verify_successful_task_count("Browser", 0)
        self._verify_complete_task_count("DB", 10)
        self._verify_reports_for(["DB"])
        self._verify_log()
        self._verify_model_copy()
    ...
    def test_ignore_error(self):
        ...
        self._verify_valid_model()
        self._verify_no_warnings()
        self._verify_successful_task_count("Browser", 1)
        self._verify_reports_for(["DB"])
        self._verify_log()
        self._verify_model_copy()
