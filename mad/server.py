...
class Server(CompositeAgent):
    ...
    def __init__(self, identifier, service_time=Constant(5), queue=Queue.fifo([]), throttling=StaticThrottling(0), scalability=Controller(10), back_off=ExponentialBackOff.factory):
